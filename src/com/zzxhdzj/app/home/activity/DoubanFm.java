...
import com.zzxhdzj.app.channels.ChannelsExpandablelistFragment;
...
//    RadioGroup mShortcutControl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMhzName = (android.widget.TextView) this.findViewById(R.id.mhz_name);
        mListenedCount = (android.widget.TextView) this.findViewById(R.id.listened_count);
        mFavoredCount = (android.widget.TextView) this.findViewById(R.id.favored_count);
        mPersonalInfo = (android.widget.LinearLayout) this.findViewById(R.id.personal_info);
        mLeftControl = (android.widget.LinearLayout) this.findViewById(R.id.left_control);
        mLeftSkipButton = (android.widget.ImageView) this.findViewById(R.id.left_skip_button);
        mLeftBanButton = (android.widget.ImageView) this.findViewById(R.id.left_ban_button);
        mLeftFavButton = (android.widget.ImageView) this.findViewById(R.id.left_fav_button);
        mAboutMe = (android.widget.ImageButton) this.findViewById(R.id.about_me);
        mRootView = (android.widget.FrameLayout) this.findViewById(R.id.root_view);
        mBtnChannelsGrid = (android.widget.ImageButton) this.findViewById(R.id.btn_channels_grid);
        mBottomControlLayout = (android.widget.LinearLayout) this.findViewById(R.id.bottom_control_layout);
...
//        mShortcutControl.setVisibility(View.VISIBLE);
    ...
    private void showChannelsFragment() {
        ...
        ChannelsExpandablelistFragment fragment = new ChannelsExpandablelistFragment();
